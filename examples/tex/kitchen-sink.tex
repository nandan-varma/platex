...
\cite{lamport1994latex} building the tooling most authors use, and archives
like \cite{ctan2023} distributing its packages. See
\url{https://ctan.org} for the package archive.
